      ...
      <div className='container'>
        <div className='w-full sm:w-1/2 my-11 mx-auto'>
          <div>
            ...
            <div className='py-4'>
              <p className='text-lg'>Bạn đã có tài khoản ?
                <Link to={'/login'}> <span className='text-blue-500 text-lg underline cursor-pointer'>Đăng nhập tại đây</span></Link></p>
            </div>
            ...
            <div className='px-16 py-6 w-full'>
              <button onClick={handleRegister}
                type='button' className='bg-[#919191] w-full py-3 rounded-lg cursor-pointer text-[#fff]'>Đăng ký</button>
            </div>
            <div>
