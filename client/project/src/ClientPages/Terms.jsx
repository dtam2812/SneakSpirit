        ...
        <div className='text-left pb-20 px-3 sm:pl-0'>
          ...
          <div>
            ...
            <div className='space-y-3 pt-16'>
              <h1 className='text-2xl'>2. Chấp nhận đơn hàng và giá cả</h1>
            ...
            <div className='space-y-3 pt-16'>
              <h1 className='text-2xl'>5. Quy định về bảo mật</h1>
            ...
            <div className='space-y-3 pt-16'>
              <h1 className='text-2xl'>6. Thay đổi, hủy bỏ giao dịch tại website</h1>
