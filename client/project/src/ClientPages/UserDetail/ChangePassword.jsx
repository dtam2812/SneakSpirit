  ...
  const handleUpdateUserPassword = async () => {
    ...
    try {
      const response = await axios.put(
        `auth/admin/user/update_password/${user._id}`,
        {
          oldPassword: oldPass,
          newPassword: newPass,
        },
    ...
    <div className="p-3 text-left">
      ...
      <div className="space-y-5 text-lg">
        ...
        <button
          ...
          className="border border-[#919191] bg-[#919191] h-10 rounded-lg w-2/3 sm:w-1/4 xl:w-1/6 text-white text-md font-bold hover:text-white hover:opacity-80 transition-colors"
        >
          Đặt lại mật khẩu
        </button>
